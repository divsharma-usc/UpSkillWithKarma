...
public class KCId {
  ...
  public KCId(String cId, String psid, String operator) {
    this.cId = cId;
    this.psid = psid;
    this.operator = operator;
  }

  public static KCId fromValue(Value value$) throws IllegalArgumentException {
    ...
    return new hackademy.kc.lang.KCId(cId, psid, operator);
  }
  ...
  public boolean equals(Object object) {
    ...
    if (!(object instanceof KCId)) {
      return false;
    }
    KCId other = (KCId) object;
  ...
  public String toString() {
    return String.format("hackademy.kc.lang.KCId(%s, %s, %s)", this.cId, this.psid, this.operator);
  }
}
