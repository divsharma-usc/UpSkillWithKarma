...
public class Approve_KC {
  ...
  public static Approve_KC fromValue(Value value$) throws IllegalArgumentException {
    ...
    return new hackademy.kc.kc.Approve_KC();
  }
  ...
  public boolean equals(Object object) {
    ...
    if (!(object instanceof Approve_KC)) {
      return false;
    }
    return true;
  }
  ...
  public String toString() {
    return "hackademy.kc.kc.Approve_KC";
  }
}
